  ...
  return (
    <div className="flex flex-col items-center justify-center w-screen h-screen">
      <div className="shadow-xl space-y-3 p-4 flex flex-col items-center justify-center rounded-lg w-full">
        ...
        <div
          className="btn large bg-gradient p-2 rounded-lg text-white w-full flex flex-col items-center justify-center focus:bg-zinc-700 hover:bg-fuchsia-300 cursor-pointer"
          onClick={login}
        >
